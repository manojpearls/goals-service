...
public class AuthClient {
    ...
    public String getAccountConsent(String authorizationToken) {
        ...
        String requestBodyJson = "{\"Data\":{\"Permissions\":[\"ReadAccountsDetail\",\"ReadBalances\",\"ReadTransactionsCredits\",\"ReadTransactionsDebits\",\"ReadTransactionsDetail\",\"NWGOpenAccount\"]},\"Risk\":{}}";
    ...
    public boolean addAccount(String accountName,String authorizationCode){
